...
import in.zipgo.automation_framework.pages.web.NewRouteCreation;
...
public class CreateNewRoute {
	 ...
	 @Test(priority=3)
     public void createNewRoute() throws BiffException, IOException{
              
		 NewRouteCreation newRoute=new NewRouteCreation();
		 newRoute.newroutes();
